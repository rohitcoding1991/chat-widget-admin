      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <div className="mt-5 max-w-3xl text-center mx-auto">
          <p className="text-lg text-gray-600 dark:text-neutral-400">
            This project shows how to integrate NextAuth with a Node.js Backend which is built with
            express and MongoDB. The backend uses JWT for authentication and authorization. The
            frontend is built with Next.js, Preline and Tailwind CSS.
          </p>
        </div>
